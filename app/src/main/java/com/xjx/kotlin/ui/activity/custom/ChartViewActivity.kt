...
class ChartViewActivity : BaseBindingTitleActivity<ActivityChartViewBinding>() {
	...
	override fun getBinding(inflater: LayoutInflater, container: ViewGroup?, attachToRoot: Boolean): ActivityChartViewBinding {
		return ActivityChartViewBinding.inflate(inflater, container, attachToRoot)
	}
