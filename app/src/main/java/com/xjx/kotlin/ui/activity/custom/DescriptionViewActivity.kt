...
class DescriptionViewActivity : BaseBindingTitleActivity<ActivityDescriptionViewBinding>() {
    override fun getTitleContent(): String = "文字描述的View"

    override fun getBinding(
        inflater: LayoutInflater,
        container: ViewGroup?,
        attachToRoot: Boolean
    ): ActivityDescriptionViewBinding = ActivityDescriptionViewBinding.inflate(inflater, container, true)
    ...
    override fun initData(savedInstanceState: Bundle?) {
        mBinding.btnStart.setOnClickListener {
            lifecycleScope.launch {
                ...
                mBinding.vDv.onScore(score, content)
            }
        }
    }
}
