...
// 		JarOutputStream(output.get().asFile.outputStream().buffered()).use { jarOutput ->
// 			//write jars
...
// 				}
// 			}
// 			project.providers.gradleProperty("enableConfig")
...
// 	}
//
// 	private fun String.toVHALPermission(): String {
// 		return "<uses-permission android:name=\"${this}\"/>";
// 	}
//
// 	private fun String.toRSIPermission(): String {
// 		return if (this.equals("CLUSTERSDS", true)) {
...
// 			rsiEnableFunctions = parseEnableFunctions(this) {
// 				it.trim().startsWith("rsi", true)
// 						&& it.contains(":")
// 			}
// 			vhalEnableFunctions = parseEnableFunctions(this) {
// 				it.trimStart()
// 					.startsWith("vhal")
// 						&& it.contains(":")
// 			}
// 		}
// 		val permissions = rsiEnableFunctions
// 			.map { it.toRSIPermission() }
// 			.toMutableList()
// 		writeClass(jarOutput, pool,
...
// 		writeClass(jarOutput, pool, onVehicleControlManager = { clazz ->
...
//
//
// 	private fun parseEnableFunctions(list: List<String>, filterStart: (String) -> Boolean): List<String> {
// 		return buildList {
